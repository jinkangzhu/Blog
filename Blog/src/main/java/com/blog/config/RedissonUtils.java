...
public class RedissonUtils {
    ...
    private static String masterCluster;

    @Value("spring.redis.cluster.slave.nodes")
    private static String slaveCluster;
    ...
    static {
        ...
        masterSlaveServersConfig.setMasterAddress(masterCluster);
        masterSlaveServersConfig.addSlaveAddress(slaveCluster.split(","));
